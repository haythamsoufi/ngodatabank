  ...
  void updateUserRole(String role) {
    if (_currentUser != null) {
      _currentUser = User(
        ...
        role: role,
        chatbotEnabled: _currentUser!.chatbotEnabled,
        profileColor: _currentUser!.profileColor,
        countryIds: _currentUser!.countryIds,
      );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 302) {
        ...
        _currentUser = User(
          ...
          chatbotEnabled: currentUser.chatbotEnabled,
          profileColor: color,
          countryIds: currentUser.countryIds,
        );
