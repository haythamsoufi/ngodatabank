...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'pdf_viewer_download_failed_http': 'Download failed (HTTP %s).',
      ...
      // Indicator detail
      'indicator_detail_failed_details': 'Failed to load indicator details: %s',
      'indicator_load_failed_with_reason': 'Failed to load indicator: %s',
  ...
  String pdfViewerDownloadFailedHttp(int code) =>
      translate('pdf_viewer_download_failed_http').replaceAll('%s', '$code');
  ...
  String httpError(int code) => translate('http_error').replaceAll('%s', '$code');
  ...
  String indicatorDetailFailedWithReason(String detail) =>
      translate('indicator_detail_failed_details').replaceAll('%s', detail);
  String indicatorLoadFailedWithReason(String detail) =>
      translate('indicator_load_failed_with_reason').replaceAll('%s', detail);
