...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'session_logs_filters': 'Filters',
      'session_logs_email_hint': 'Search by email',
      'session_logs_min_duration': 'Min duration (min)',
      'session_logs_active_only': 'Active sessions only',
      'session_logs_apply': 'Apply',
      'session_logs_clear': 'Clear',
    ...
    'es': {
      ...
      'session_logs_filters': 'Filtros',
      'session_logs_email_hint': 'Buscar por correo',
      'session_logs_min_duration': 'Duración mín. (min)',
      'session_logs_active_only': 'Solo sesiones activas',
      'session_logs_apply': 'Aplicar',
      'session_logs_clear': 'Borrar',
    ...
    'fr': {
      ...
      'session_logs_filters': 'Filtres',
      'session_logs_email_hint': 'Rechercher par e-mail',
      'session_logs_min_duration': 'Durée min. (min)',
      'session_logs_active_only': 'Sessions actives uniquement',
      'session_logs_apply': 'Appliquer',
      'session_logs_clear': 'Effacer',
    ...
    'ar': {
      ...
      'session_logs_filters': 'عوامل التصفية',
      'session_logs_email_hint': 'البحث بالبريد الإلكتروني',
      'session_logs_min_duration': 'الحد الأدنى للمدة (دقيقة)',
      'session_logs_active_only': 'الجلسات النشطة فقط',
      'session_logs_apply': 'تطبيق',
      'session_logs_clear': 'مسح',
    ...
    'hi': {
      ...
      'session_logs_filters': 'फ़िल्टर',
      'session_logs_email_hint': 'ईमेल से खोजें',
      'session_logs_min_duration': 'न्यूनतम अवधि (मि.)',
      'session_logs_active_only': 'केवल सक्रिय सत्र',
      'session_logs_apply': 'लागू करें',
      'session_logs_clear': 'साफ़ करें',
    ...
    'ru': {
      ...
      'session_logs_filters': 'Фильтры',
      'session_logs_email_hint': 'Поиск по email',
      'session_logs_min_duration': 'Мин. длительность (мин)',
      'session_logs_active_only': 'Только активные сессии',
      'session_logs_apply': 'Применить',
      'session_logs_clear': 'Сбросить',
    ...
    'zh': {
      ...
      'session_logs_filters': '筛选',
      'session_logs_email_hint': '按邮箱搜索',
      'session_logs_min_duration': '最短时长（分钟）',
      'session_logs_active_only': '仅活跃会话',
      'session_logs_apply': '应用',
      'session_logs_clear': '清除',
  ...
  String get sessionLogsFilters => translate('session_logs_filters');
  ...
  String get sessionLogsApply => translate('session_logs_apply');
  String get sessionLogsClear => translate('session_logs_clear');
