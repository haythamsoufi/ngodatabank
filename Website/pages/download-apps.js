        ...
        <div className="w-full h-full px-4 sm:px-6 lg:px-12 py-6 sm:py-8 lg:py-10">
          ...
          <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
            <div className="bg-white rounded-xl shadow-lg border-2 border-ngodb-gray-200 p-6 sm:p-8">
              <h2 className="text-2xl font-bold text-ngodb-navy mb-2 text-center">
                <TranslationSafe fallback="Try the Android app in your browser">
                  {t('downloadApps.demo.title')}
                </TranslationSafe>
              </h2>
              <p className="text-sm sm:text-base text-ngodb-gray-600 text-center mb-6 max-w-2xl mx-auto">
              ...
              {isAllowedEmbedUrl(androidDemoEmbedUrl) ? (
                <div className="relative w-full max-w-[400px] mx-auto rounded-xl overflow-hidden border border-ngodb-gray-200 bg-ngodb-gray-900 shadow-inner aspect-[9/16] max-h-[min(85vh,820px)]">
                  <iframe
                    title="NGO Databank Android demo"
                ...
                <p className="text-sm text-ngodb-gray-600 text-center max-w-xl mx-auto py-4 px-4 bg-ngodb-gray-50 rounded-lg border border-dashed border-ngodb-gray-300">
