...
export default function Footer() {
  ...
  return (
    <footer className="bg-humdb-navy text-humdb-gray-300 py-8" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-8">
          ...
          >
            ...
            <div className="text-xs mb-2">
              <a href="#" className="hover:text-humdb-red mx-2 transition-colors">
            ...
            <p className="text-xs">
              <TranslationSafe fallback={`© ${currentYear} ${siteTitle}. All rights reserved.`}>
                {(() => {
                  ...
                  return c.replace(/Humanitarian Databank/g, siteTitle);
                })()}
              </TranslationSafe>
            </p>
          ...
          <div className="text-center lg:col-span-3">
            <div className="bg-gradient-to-r from-humdb-green/20 to-humdb-blue-600/20 backdrop-blur-sm border border-humdb-green/30 rounded-xl p-4 shadow-lg h-full">
              <div className="flex items-center justify-center mb-3">
                <div className={`bg-humdb-green/20 rounded-full p-2 ${isRTL ? 'ml-3' : 'mr-3'}`}>
                  <svg className="w-6 h-6 text-humdb-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-humdb-white font-semibold text-lg">
                  <TranslationSafe fallback="Mobile Apps">
                    {t('footer.mobileApps.title')}
                  </TranslationSafe>
                </h3>
              </div>
              <p className="text-sm mb-4 text-humdb-gray-300 leading-relaxed">
              ...
              <div className="flex items-center justify-center gap-4">
                <Link
                  href="/download-apps"
                  className="inline-flex items-center justify-center w-10 h-10 bg-humdb-green/20 hover:bg-humdb-green/30 rounded-full transition-all duration-200 group"
                  title={t('footer.mobileApps.downloadAndroid')}
                  aria-label={t('footer.mobileApps.downloadAndroid')}
                >
                  <svg className="w-6 h-6 text-humdb-green group-hover:scale-110 transition-transform" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link
                  href="/download-apps"
                  className="inline-flex items-center justify-center w-10 h-10 bg-humdb-blue-600/20 hover:bg-humdb-blue-600/30 rounded-full transition-all duration-200 group"
          ...
          <div className={`text-center lg:${isRTL ? 'text-left' : 'text-right'} lg:col-span-5`}>
            <div className="bg-gradient-to-r from-humdb-red/20 to-humdb-red/10 backdrop-blur-sm border border-humdb-red/30 rounded-xl p-6 shadow-lg h-full">
              <div className={`flex items-center justify-center lg:${isRTL ? 'justify-start' : 'justify-end'} mb-3`}>
                <div className={`bg-humdb-red/20 rounded-full p-2 ${isRTL ? 'ml-3' : 'mr-3'}`}>
              ...
              <div className={`flex items-center justify-center lg:${isRTL ? 'justify-start' : 'justify-end'} gap-4`}>
                <Link
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 bg-humdb-red/20 hover:bg-humdb-red/30 border border-humdb-red/30 rounded-full transition-all duration-200 group"
                  title="Read API Documentation"
                  aria-label="Read API Documentation"
                >
                  <svg className="w-5 h-5 text-humdb-red group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
