...
class EmergencyOperationsFieldType(BaseFieldType):
    ...
    def get_entry_form_config(self) -> Dict[str, Any]:
        return {
            'template': 'field.html',
            'es_module_path': '/plugins/emergency_operations/static/js/emergency_operations_field.js',
            'es_module_class': 'EmergencyOperationsField',
            'css_files': ['/plugins/emergency_operations/static/css/emergency_operations_field.css'],
