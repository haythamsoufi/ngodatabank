...
Detailed setup and configuration for optional Backoffice features and production deployment.

## In this section

- **[LibreTranslate](libretranslate.md)** – Optional translation service (Docker, env vars, enabling).
- **[Azure storage mounts](azure-storage-mounts.md)** – Path mappings (Azure Files) for persistent files (e.g., translations).
