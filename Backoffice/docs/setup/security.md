...
- **Recommended:** Use Authorization header: `Authorization: Bearer YOUR_API_KEY`
- **Deprecated:** Query parameter `?api_key=YOUR_API_KEY` (still supported but will log warnings)
