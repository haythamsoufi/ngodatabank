# Data guidance for unified planning and reporting

Use this guide when you need to understand what quantitative data is required for unified planning and reporting, how the forms are structured, and how to fill in each section correctly.
...
| Cycle | Period |
|---|---|
| Mid-year progress report | January – June |
| Annual report | January – December |

Both narrative and quantitative data are reported, including a set of **mandatory indicators** covering:

- key National Society figures
- impact and reach indicators against Strategic Priorities
- institutional indicators against Enabling Functions
...
| Unified Country Plan | Unified Country Report |
|---|---|
| Key National Society figures | Key National Society figures |
...
| Term | Definition |
|---|---|
| **Volunteers** | People who have given their time voluntarily to support the delivery of services of the reporting National Society for at least four hours during the reporting year. |
| **Staff** | People who are contracted by the reporting National Society for a minimum of three months in total during the reporting year and are either remunerated for their work or are interns. |
| **Branches** | A branch has its roles, responsibilities, and relationship with National Headquarters defined through the National Society's Statutes, including autonomy in legal status, local resource mobilization, local partnerships, and decision-making through branch members, board, and volunteers. |
...
## Unified Country Plan — section by section

The **Unified Country Plan** form contains the following sections. All sections appear on a single page.

### National Society key figures

Enter the four key figures for the National Society:
...
| Local Units | Number of local units |

See [key definitions](#key-national-society-figures) above for what each term means.
...
This section captures a snapshot of the support the National Society expects from participating National Societies (PNSs) that plan to work **bilaterally** (not multilaterally).

Use the matrix to list each PNS and tick the Strategic Priorities or Enabling Functions they will support. The PNSs you list here will also appear in the Funding Requirements section so you can enter funding from each.

### Funding requirements (CHF)

This section is broken into **three sub-sections** — one for the current assignment period and two for the following years — providing a three-year funding outlook.
...
A free-text field to add any comments or additional information about the data you entered. These comments are used by the Federation-wide Data Systems team during validation and reduce follow-up questions.

> Tip: adding context here saves time — it avoids back-and-forth clarification requests after you submit.

---

## Unified Country Report — section by section

The **Unified Country Report** form is organized into **5 pages**, navigable from the left sidebar.

### Page 1 — Overall Action Indicators

This is the main data entry page, containing the following sections:

#### NS Data

The same four key figures as the plan: **Volunteers**, **Staff**, **Local Units**, and **Branches**. Enter the actual figures for the reporting year.

#### Overall Action Indicators (core indicators)

This section contains the mandatory core indicators organized by Strategic Priority (SP) and Enabling Function (EF):

| Group | Indicators |
|---|---|
| **Cross Cutting** | People reached with long-term services; people reached with emergency response and early recovery |
| **SP 1 — Climate and environment** | People reached addressing climate risks; heatwave activities; environmental problems; nature-based solutions; environmental campaigns; climate strategies |
| **SP 2 — Disasters and crises** | Disaster risk reduction; emergency response; cash and vouchers percentage; livelihoods support; shelter support |
| **SP 3 — Health and wellbeing** | Health services; WASH; first aid training; blood donation; psychosocial and mental health; immunization |
| **SP 4 — Migration and displacement** | Migrants and displaced persons reached; Humanitarian Service Points; advocacy and communications; data collection and research |
...
This is a dynamic section where you can **add additional indicators** from the Indicator Bank beyond the core set. Use the "Add Indicator" button to search and select indicators relevant to your National Society's activities.

### Page 2 — Emergency Appeals Indicators

This page shows **active Emergency Appeals** pulled from the GO platform. For each active appeal, a dynamic section allows you to select and report against relevant indicators from the Indicator Bank.
...
This page captures the bilateral support **actually received** (as opposed to the *planned* support in the plan).

- Areas that were included in the Unified Plan are automatically pre-listed.
- Tick the areas supported by PNSs bilaterally (or through PNS consortia), whether completed or still ongoing.
- If there are new activities not originally planned under an existing PNS, add and tick them too.

### Page 5 — Comments

A free-text field to add any comments or additional information about the data you reported. These comments are used by the Federation-wide Data Systems team during validation and reduce follow-up questions.
...
- [Fill and submit a form](submit-data.md)
