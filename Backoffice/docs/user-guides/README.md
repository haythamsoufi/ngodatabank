...
- [Assignment lifecycle](admin/assignment-lifecycle.md)
- [Run a reporting cycle](admin/run-a-reporting-cycle.md)
- [Review and approve submissions](admin/review-approve-submissions.md)
- [Public URL submissions](admin/public-url-submissions.md)
...
- [Troubleshooting templates and assignments (Admin)](admin/troubleshooting-templates-and-assignments.md)
- [Notifications and communications (Admin)](admin/notifications-and-communications.md)
