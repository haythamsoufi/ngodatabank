...
class AIReasoningTrace(db.Model):
    ...
    # Optional extensible diagnostics (JSON). Convention: keyed sections, e.g. user_attribution.
    trace_diagnostics = Column(JSON, nullable=True)
    ...
    def to_dict(self, include_steps=True):
        ...
        result = {
            ...
            'created_at': self.created_at.isoformat() if self.created_at else None,
            'trace_diagnostics': getattr(self, 'trace_diagnostics', None),
        }
