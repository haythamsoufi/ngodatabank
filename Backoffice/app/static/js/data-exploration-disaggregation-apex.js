...
(function(global) {
    ...
    function initOrUpdateCoverageYearFilter(p) {
        ...
        el.innerHTML = years.map(y => `<option value="${y}"${selectedSet.has(y) ? ' selected' : ''}>${y}</option>`).join('');
                        ...
                        <tr style="background-color: ${rowBg};">
                            ...
                            <td class="px-6 py-3 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold" style="background-color: ${badgeBg}; color: ${badgeText};">
                                    ${c.overallDisaggregation}%
                                </span>
                            </td>
                            <td class="px-6 py-3 whitespace-nowrap">
                                <div class="w-32 bg-gray-200 rounded-full h-2">
                                    <div class="h-2 rounded-full transition-all duration-500" style="width: ${c.overallDisaggregation}%; background-color: ${barColor};"></div>
                                </div>
                            </td>
                        </tr>
                    `;
