...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayNotifications(notifications) {
        ...
        notifications.forEach(notification => {
            ...
            const icon = notification.icon && typeof notification.icon === 'string' ?
                         notification.icon.replace(/[^a-zA-Z0-9\-\s]/g, '') : '';
            ...
            if (icon) {
                ...
                iconEl.className = `fas ${icon} mr-2 text-sm ${iconColor}`;
            ...
            messageP.className = 'text-sm mt-1 notification-message-text';
