    ...
    async setupPluginConfigListeners(modalElement, configContainer, listId) {
        ...
        try {
            ...
            if (!handler || typeof handler !== 'function') {
                ...
                // Plugin static files are served at: /plugins/{plugin_name}/static/{path}
                // For emergency_operations, this would be: /plugins/emergency_operations/static/js/matrix_config_handler.js
                const pluginName = this.getPluginNameFromListId(listId);
                if (pluginName) {
                    try {
                        const module = await import(`/plugins/${pluginName}/static/js/matrix_config_handler.js`);
