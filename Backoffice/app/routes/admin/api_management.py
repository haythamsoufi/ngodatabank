...
#   'api_key'            – @require_api_key (DB-managed Bearer key)
...
MOBILE_ENDPOINT_REGISTRY = [
    ...
    {'group': 'Admin: Content', 'path': '/api/mobile/v1/admin/content/templates/<template_id>/delete', 'methods': ['POST'],
     ...
     'flutter': 'TemplatesProvider'},
    {'group': 'Admin: Content', 'path': '/api/mobile/v1/admin/content/templates/<template_id>/duplicate', 'methods': ['POST'],
     'auth': 'rbac', 'permission': 'admin.templates.duplicate',
