...
from app.utils.email_delivery_tracking import log_email_attempt, mark_email_sent, mark_email_failed
...
def _translate_notification_for_email(notif, locale: Optional[str]) -> tuple:
    ...
    try:
        ...
        with force_locale(locale):
            title = translate_notification_message(title_key, title_params, locale=locale) if title_key else notif.title
