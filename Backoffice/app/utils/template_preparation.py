...
from app.utils.form_processing import get_form_items_for_section, FormItemProcessor, _process_dynamic_indicators_for_section
...
class TemplatePreparationService:
    ...
    def prepare_template_for_rendering(cls, template, assignment_entity_status=None, is_preview_mode: bool = False) -> tuple:
        ...
        for section_obj in all_sections:
            ...
            # Debug logging similar to previous implementation
        ...
        current_app.logger.debug(f"Template preparation complete: {template.name}, Sections: {len(all_sections)}")
