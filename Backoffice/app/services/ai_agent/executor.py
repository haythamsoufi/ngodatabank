                ...
                if not message.tool_calls:
                    ...
                    if (
                        ...
                        messages.append({
                            "role": "user",
                            "content": (
                                "You must invoke the search_documents tool (via function/tool calling) before concluding no data. "
                                "Documents often contain this information even when the indicator bank does not. "
                                "Use a short query phrase such as 'branches Myanmar' (or terms relevant to this request)—do not paste JSON arguments in text. "
                        ...
                        messages.append(
                            {
                                ...
                                "content": "".join(
                                    [
                                        ...
                                        "Invoke the search_documents tool through function/tool calling (not JSON in your reply). "
                                        f"Suggested search phrase: \"{doc_q}\". ",
                                        (f"Prefer country filter: \"{doc_country}\". " if doc_country else ""),
                                        "Use a modest top_k (e.g. 8) unless you are doing a full multi-country inventory.\n",
