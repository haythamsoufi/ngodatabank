...
def _apply_enrichment(
    ...
    t0 = _time.monotonic()
    spec = _analyze_needed_columns(enrichment_query, existing_keys, metric, client, model)
    cols_to_add = [
    ...
    if uncached:
        generated = _generate_enrichment_values(uncached, cols_to_add, client, model)
