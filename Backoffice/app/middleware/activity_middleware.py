...
_SKIP_ENDPOINTS = frozenset([
    ...
    # CSRF token refresh (AJAX housekeeping)
    'utilities.refresh_csrf_token',
    'utilities.refresh_csrf_token_get',
    # Form helper APIs (typeahead, lookup options, dynamic render, matrix config)
    ...
    # User edit page — JSON / hierarchy helpers (GET); shell route is user_management.edit_user
    ...
    # AI document IFRC pickers, admin AI JSON, settings check, translation status, WS
