...
Databank API = current app (BASE_URL: localhost or databank.ifrc.org depending where the app runs).
Bearer token from FDRS_DATABANK_API_KEY or DATABANK_API_KEY for API key auth.
...
DEFAULT_FDRS_DATA_API_KEY = os.environ.get("FDRS_DATA_API_KEY", "21e401ae-6b35-404b-a72a-b74cce66dee3")
...
DEFAULT_INDICATOR_BANK_API_KEY = "878c8a2d-9cf6-488e-9350-eae19e26152f"
...
def run_import(
    ...
    with app.app_context():
        if fdrs_from_data_api:
            ...
            base_data = (fdrs_data_api_base or DEFAULT_FDRS_DATA_API_BASE).rstrip("/")
            ...
            # Use explicit key, then env FDRS_DATABANK_API_KEY/DATABANK_API_KEY, then current app's API_KEY
            databank_key = databank_api_key or DEFAULT_DATABANK_API_KEY or current_app.config.get("API_KEY")
            ...
            fdrs_data, disagg_by_key, exclusion_summary, fdrs_snapshot_rows = build_fdrs_table(
                base_url=base_data,
                api_key=fdrs_data_api_key or DEFAULT_FDRS_DATA_API_KEY,
                years=fdrs_years,
