...
def seed_test_data():
    ...
    try:
        ...
        if not os.environ.get('TEST_ADMIN_PASSWORD') or not os.environ.get('TEST_FOCAL_PASSWORD'):
            click.echo(
...
if __name__ == '__main__':
    ...
    if debug_env is not None:
        ...
        # Only enable debug for explicit development mode — staging and other
        # non-production configs must NOT get the Werkzeug interactive debugger.
        debug = os.environ.get("FLASK_CONFIG", "").lower() in ("development", "default", "")
